...
# Fungsi untuk mencetak status tes
...
def test_create_pesanan(mock_load_document, mock_save_document):
    try:
        ...
        print_test_status("test_create_pesanan", "passed")
    except AssertionError:
        print_test_status("test_create_pesanan", "failed")
        raise
...
def test_update_pesanan(mock_load_document, mock_save_document):
    try:
        ...
        print_test_status("test_update_pesanan", "passed")
    except AssertionError:
        print_test_status("test_update_pesanan", "failed")
        raise
...
def test_delete_pesanan(mock_load_document, mock_save_document):
    try:
        ...
        print_test_status("test_delete_pesanan", "passed")
    except AssertionError:
        print_test_status("test_delete_pesanan", "failed")
        raise
...
def test_read_pesanan(mock_load_document, monkeypatch):
    try:
        ...
        print_test_status("test_read_pesanan", "passed")
    except AssertionError:
        print_test_status("test_read_pesanan", "failed")
        raise
